...
6.  Prompt Design
    ...
    Prompt:
    ```
    "Does the word '{guess}' beat the word '{word}' logically, creatively, or realistically. Answer should be based on general knowledge and reasoning. Response should start with 'YES' or 'NO', followed by a very short one line justification."
    ```
